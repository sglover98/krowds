 ...
 * 
 */ 
$krowd_options = krowd_get_options();
$krowd_logo = KROWD_THEME_URL . '/images/logo.png';
if(isset($krowd_options['header_logo']['url']) && $krowd_options['header_logo']['url']){
  $krowd_logo = $krowd_options['header_logo']['url'];
}
            ...
            <div class="header-bottom-inner">
              ...
              <div class="logo">
                <a class="logo-theme" href="<?php echo esc_url( home_url( '/' ) ); ?>">
                  <img src="<?php echo esc_url($krowd_logo); ?>" alt="<?php bloginfo( 'name' ); ?>" />
                </a>
              </div>
