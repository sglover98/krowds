<?php 
  get_header(apply_filters('krowd_get_header_layout', null )); 
  wp_enqueue_script( 'waypoints' );
  
  $page_id = krowd_id();
  $page_title_style = get_post_meta($page_id, 'krowd_page_title_style', true );
      ...
      <div class="content-page col-xs-12">      
        <?php while ( have_posts() ) : the_post(); ?>
          <?php
            ...
            $team_quote = get_post_meta(get_the_id(), 'krowd_team_quote', true );
            $team_email = get_post_meta(get_the_id(), 'krowd_team_email', true );
            $team_phone = get_post_meta(get_the_id(), 'krowd_team_phone', true );
            $team_address = get_post_meta(get_the_id(), 'krowd_team_address', true );
          ...
          <div class="team-block-single clearfix single row">
            <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-xs-12 team-image">
              <div class=" team-thumbnail">
                ...
                <div class="heading"><?php echo esc_html__('Contact Info', 'krowd') ?></div>
                
                <?php if($team_email){ ?>
                  <div class="team-email"><?php echo esc_html__('Email: ', 'krowd') ?>
                    <a href="mailto:<?php echo esc_html( $team_email ) ?>"><?php echo esc_html( $team_email ) ?></a>
                  </div>
                <?php } ?>

                <?php if($team_phone){ ?>
                  <div class="team-phone"><?php echo esc_html__('Phone: ', 'krowd') ?>
            ...
            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-xs-12">
              ...
              <?php if( is_array($team_educations) && isset($team_educations[1]) ){ ?>
                <div class="team-educations">
                  <div class="heading"><?php echo esc_html__('Educations', 'krowd') ?></div>
              ...
              <?php if( is_array($team_skills) && isset($team_skills[1]) ){ ?>
                <div class="team-skills clearfix margin-bottom-30">
                  <div class="heading"><?php echo esc_html__('Skills', 'krowd') ?></div>
                  <div class="clearfix">
